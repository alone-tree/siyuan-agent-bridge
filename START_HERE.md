# Start Here For SiYuan Agent Bridge

This repository contains a private SiYuan Agent Bridge adapter.

If you are an AI agent and the user asks you to use their notes, personal knowledge base, SiYuan, notebook, prior materials, writing archive, research archive, or project context, use the SiYuan Agent Bridge workflow.
...
3. If MCP is unavailable, tell the user the SiYuan Agent Bridge MCP is not registered or not reachable. Do not fall back to scanning files.
